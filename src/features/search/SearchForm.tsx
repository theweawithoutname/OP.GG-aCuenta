  ...
  return (
    <form onSubmit={handleSubmit} className="flex space-x-2">
      ...
      <select
        ...
        className="w-full p-3 border-none bg-[#252525] text-[#e8e8e8] text-sm font-medium"
      >
      ...
      <div className=" min-w-[300px] my-3 mx-[5px]
                  ...
                  before:border-b before:border-white/40

                  after:content-[''] after:absolute after:inset-x-0 after:bottom-0
                  after:border-b-2 after:border-lime-400
                  after:scale-x-0 after:transition-transform after:duration-250
      ...
      <input
        ...
        className="
                  ...
                  w-full p-3 
                  bg-[#252525] text-[#e8e8e8] text-sm font-medium
                  rounded-t-[5px]
